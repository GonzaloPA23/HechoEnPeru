...
public class LocalCraftsmanService implements ILocalCrastmanService {
    ...
    @Override
    public List<LocalCraftsman> listLocalCraftsmenByRegion(Long id){
    ...
    @Override
    public List<LocalCraftsman> listAllLocalCraftsmen(){
        return localCraftsmanRepository.listAllLocalCraftsmen();
    }
